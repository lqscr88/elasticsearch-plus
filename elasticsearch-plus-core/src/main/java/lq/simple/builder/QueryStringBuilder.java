...
public class QueryStringBuilder extends AbstractQueryBuilder<QueryStringBuilder>  {
...
//    private static final ParseField FUZZY_TRANSPOSITIONS_FIELD = new ParseField("fuzzy_transpositions");
    ...
    public static QueryStringBuilder queryStringQuery(String queryString) {
     ...
     */
    public QueryStringBuilder field(String field) {
     ...
     */
    public QueryStringBuilder field(String field, float boost) {
     ...
     */
    public QueryStringBuilder fields(Map<String, Float> fields) {
     ...
     */
    public QueryStringBuilder type(MultiMatchQueryBuilder.Type type) {
        this.type = type;
        return this;
    }
     ...
     */
    public QueryStringBuilder tieBreaker(float tieBreaker) {
     ...
     */
    public QueryStringBuilder defaultOperator(Operator defaultOperator) {
     ...
     */
    public QueryStringBuilder analyzer(String analyzer) {
     ...
     * defined for it, then it will be used automatically. Defaults to the smart search analyzer.
     */
    public QueryStringBuilder quoteAnalyzer(String quoteAnalyzer) {
     ...
     */
    public QueryStringBuilder maxDeterminizedStates(int maxDeterminizedStates) {
     ...
     */
    public QueryStringBuilder allowLeadingWildcard(Boolean allowLeadingWildcard) {
     ...
     */
    public QueryStringBuilder enablePositionIncrements(boolean enablePositionIncrements) {
     ...
     */
    public QueryStringBuilder fuzziness(Fuzziness fuzziness) {
     ...
     */
    public QueryStringBuilder fuzzyPrefixLength(int fuzzyPrefixLength) {
    ...
    public QueryStringBuilder fuzzyMaxExpansions(int fuzzyMaxExpansions) {
    ...
    public QueryStringBuilder fuzzyRewrite(String fuzzyRewrite) {
     ...
     */
    public QueryStringBuilder phraseSlop(int phraseSlop) {
    ...
    public QueryStringBuilder rewrite(String rewrite) {
     ...
     */
    public QueryStringBuilder analyzeWildcard(Boolean analyzeWildcard) {
    ...
    public QueryStringBuilder minimumShouldMatch(String minimumShouldMatch) {
     ...
     */
    public QueryStringBuilder quoteFieldSuffix(String quoteFieldSuffix) {
     ...
     */
    public QueryStringBuilder lenient(Boolean lenient) {
     ...
     */
    public QueryStringBuilder timeZone(String timeZone) {
        if (timeZone != null) {
    ...
    public QueryStringBuilder timeZone(ZoneId timeZone) {
    ...
    public QueryStringBuilder autoGenerateSynonymsPhraseQuery(boolean value) {
     ...
     */
    public QueryStringBuilder fuzzyTranspositions(boolean fuzzyTranspositions) {
...
//    public static QueryStringBuilder fromXContent(XContentParser parser) throws IOException {
...
//        int maxDeterminizedStates = QueryStringBuilder.DEFAULT_MAX_DETERMINED_STATES;
//        boolean enablePositionIncrements = QueryStringBuilder.DEFAULT_ENABLE_POSITION_INCREMENTS;
//        boolean escape = QueryStringBuilder.DEFAULT_ESCAPE;
//        int fuzzyPrefixLength = QueryStringBuilder.DEFAULT_FUZZY_PREFIX_LENGTH;
//        int fuzzyMaxExpansions = QueryStringBuilder.DEFAULT_FUZZY_MAX_EXPANSIONS;
//        int phraseSlop = QueryStringBuilder.DEFAULT_PHRASE_SLOP;
...
//        Operator defaultOperator = QueryStringBuilder.DEFAULT_OPERATOR;
//        String timeZone = null;
//        Fuzziness fuzziness = QueryStringBuilder.DEFAULT_FUZZINESS;
...
//                } else {
//                    throw new ParsingException(parser.getTokenLocation(), "[" + QueryStringBuilder.NAME +
...
//        }
//        if (queryString == null) {
//            throw new ParsingException(parser.getTokenLocation(), "[" + QueryStringBuilder.NAME + "] must be provided with a [query]");
//        }
//
//        QueryStringBuilder queryStringQuery = new QueryStringBuilder(queryString);
...
//    }
    ...
    @Override
    protected boolean doEquals(QueryStringBuilder other) {
